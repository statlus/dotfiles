...
export ZSH="/Users/statlus/.oh-my-zsh"
...
# Login using STS
aws_login() {
        python ~/aws-saml-sts/aws_saml.py
        export AWS_PROFILE=
...
POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(status custom_now_playing root_indicator background_jobs)
