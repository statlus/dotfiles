# Generated by Powerlevel10k configuration wizard on 2020-08-03 at 13:30 BST.
...
# solid, full frame, sparse, fluent, transient_prompt, instant_prompt=verbose.
...
() {
  ...
  ####################################[ spotify: CUSTOM now playing in spotify ]####################################
  typeset -g POWERLEVEL9K_CUSTOM_NOW_PLAYING='~/.nowplaying'
  typeset -g POWERLEVEL9K_CUSTOM_NOW_PLAYING_BACKGROUND='blue'
  typeset -g POWERLEVEL9K_CUSTOM_NOW_PLAYING_FOREGROUND='black'
